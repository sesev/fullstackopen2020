...
describe('Accessing blogs', () => {
  ...
  test('Editing likes of an existing blog', async () => {
    //first create a new blog to get it right for the editing user token
    const newBlog = {
      title: 'API testiblog',
      author: 'Kaitsu Karkola',
      url: 'http://www.kaitsunparatiisi.com',
  ...
  test('Adding a new blog without a token is not authorized 401', async () => {
    const forbiddenBlog = {
